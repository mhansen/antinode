...
exports.start = function(custom_settings, callback) {
    ...
    server = http.createServer(function(req,resp) {
        ...
        resp.connection.addListener('timeout', function() {
            log.debug("Connection from", req.connection.remoteAddress, "timed out.");
            resp.connection.destroy();
            // close the file descriptor of the file we're sending. Otherwise
            // if someone makes a lot of connections, then lets them run idle
            // in the middle of receiving a file, we'll run out of descriptors.
